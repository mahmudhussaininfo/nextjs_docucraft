...
export const metadata = {
  title: "Docucraft - A Documentation Builder",
  description:
    "Docucraft is a documentation builder that allows you to create beautiful and responsive documentation websites with ease. It is built with Next.js and Tailwind CSS,",
};

export default function RootLayout({ children }) {
  const allDocuments = getPostsData();
